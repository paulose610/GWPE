...
def newsignalarr(d,t,std):
    ...
    phi=np.random.uniform(1,10)
    f=np.random.uniform(0,2*pi)
...
std=4
mean=0
a,phi,f,t=getval(2,5,0,0,4,1000)
arr_sig,arr_a,arr_phi,arr_f=randomsignalarr(50,t)
data=noise(mean,std,len(t))+signal(a,phi,f,t)
